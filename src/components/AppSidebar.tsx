                        ...
                        >
                          {({ isActive }) => (
                            <div
                              className={
                                isActive
                                  ? `flex items-center gap-3 px-3 py-2 bg-primary text-primary-foreground font-semibold rounded-full shadow-sm`
                                  : `flex items-center gap-3 px-3 py-2 text-foreground hover:bg-secondary rounded-full transition-colors`
                              }
                            >
